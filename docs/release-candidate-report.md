...
| `@forgecli7/deployments`           | `0.2.0-beta.0`  |
| `@forgecli7/marketplace`           | `0.2.0-beta.0`  |
| `@forgecli7/plugin-docker`         | `0.1.1-beta.0`  |
| `@forgecli7/plugin-github-actions` | `0.2.0-beta.0`  |
| `@forgecli7/plugin-sdk`            | `0.2.0-beta.0`  |
| `@forgecli7/plugins`               | `0.2.0-beta.0`  |
| `@forgecli7/templates`             | `0.2.0-beta.0`  |
| `@forgecli7/workspaces`            | `0.2.0-beta.0`  |

## Changesets audit

| Changeset                        | Package                            | Bump  | User-facing | Summary                                                                                                                                                                                                                                                               |
| -------------------------------- | ---------------------------------- | ----- | ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `bold-workspace-builder.md`      | `@forgecli7/workspaces`            | minor | Yes         | Add the shared multi-service workspace model, validator, atomic generator, read-only scanner, built-in presets, CLI commands, and ForgeKi Desktop Workspace Builder foundation.                                                                                       |
| `bold-workspace-builder.md`      | `@forgecli7/cli`                   | minor | Yes         | Add the shared multi-service workspace model, validator, atomic generator, read-only scanner, built-in presets, CLI commands, and ForgeKi Desktop Workspace Builder foundation.                                                                                       |
...
| `calm-deployment-profiles.md`    | `@forgecli7/deployments`           | minor | Yes         | Add shared environment schemas, deterministic deployment profiles, readiness and compatibility validation, Docker/Kubernetes/static/Node configuration generation, collision-safe export, drift scanning, and deployment CLI commands.                                |
| `calm-deployment-profiles.md`    | `@forgecli7/cli`                   | minor | Yes         | Add shared environment schemas, deterministic deployment profiles, readiness and compatibility validation, Docker/Kubernetes/static/Node configuration generation, collision-safe export, drift scanning, and deployment CLI commands.                                |
...
| `safe-plugin-platform.md`        | `@forgecli7/templates`             | minor | Yes         | Add ForgeKi's declarative plugin platform: a versioned SDK, validated local storage with integrity checks, offline Marketplace providers, Stack Builder and scanner contributions, plugin-management CLI commands, bundled examples, and security-focused validation. |
| `safe-plugin-platform.md`        | `@forgecli7/plugins`               | minor | Yes         | Add ForgeKi's declarative plugin platform: a versioned SDK, validated local storage with integrity checks, offline Marketplace providers, Stack Builder and scanner contributions, plugin-management CLI commands, bundled examples, and security-focused validation. |
| `safe-plugin-platform.md`        | `@forgecli7/cli`                   | minor | Yes         | Add ForgeKi's declarative plugin platform: a versioned SDK, validated local storage with integrity checks, offline Marketplace providers, Stack Builder and scanner contributions, plugin-management CLI commands, bundled examples, and security-focused validation. |
...
| `trusted-marketplace-updates.md` | `@forgecli7/marketplace`           | minor | Yes         | Add the trusted remote Marketplace protocol, verified declarative package pipeline, revocation, offline cache, Marketplace CLI, and secure application update-checking foundations.                                                                                   |
| `trusted-marketplace-updates.md` | `@forgecli7/plugins`               | minor | Yes         | Add the trusted remote Marketplace protocol, verified declarative package pipeline, revocation, offline cache, Marketplace CLI, and secure application update-checking foundations.                                                                                   |
| `trusted-marketplace-updates.md` | `@forgecli7/cli`                   | minor | Yes         | Add the trusted remote Marketplace protocol, verified declarative package pipeline, revocation, offline cache, Marketplace CLI, and secure application update-checking foundations.                                                                                   |
| `visual-stack-builder.md`        | `@forgecli7/cli`                   | minor | Yes         | Add the shared Visual Stack Builder registry, compatibility engine, deterministic generation plans, React/Vite and Express foundations, expanded detection, and safe CLI stack commands.                                                                              |
| `visual-stack-builder.md`        | `@forgecli7/core`                  | minor | Yes         | Add the shared Visual Stack Builder registry, compatibility engine, deterministic generation plans, React/Vite and Express foundations, expanded detection, and safe CLI stack commands.                                                                              |
| `visual-stack-builder.md`        | `@forgecli7/templates`             | minor | Yes         | Add the shared Visual Stack Builder registry, compatibility engine, deterministic generation plans, React/Vite and Express foundations, expanded detection, and safe CLI stack commands.                                                                              |
...
- All ten public package builds and export-map resolution
...
- Public ESM imports from core, plugin SDK, templates, workspaces, deployments, Marketplace, Docker, and GitHub Actions packages
...
All ten packages contain package metadata, compiled ESM JavaScript, declarations, README, and MIT
...
2. Confirm ownership and availability of all ten `@forgecli7/*` package names.
...
npm cannot atomically publish ten packages. If publication stops partway through, do not unpublish
