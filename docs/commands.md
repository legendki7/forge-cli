...
With no project name, ForgeCLI prompts for a validated name, package manager, Git, Docker, and
...
ForgeCLI does not execute the workflow, install dependencies locally, call GitHub, or deploy anything.
